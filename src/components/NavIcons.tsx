...
const NavIcons = () => {
    ...
    return (
        <div className="flex items-center gap-4 xl:gap-6 relative">
            ...
            {isProfileOpen && 
                <div className="absolute p-6 rounded-1 top-10 left-0 text-sm shadow-[0_3px_10px_rgb(0,0,0,0.2)] z-20">
            ...
            <div className="relative cursor-pointer" onClick={() => setIsCartOpen((prev) => !prev)}>
                ...
                <div className="absolute -top-4 -right-4 w-4 h-4 bg-lama rounded-full text-white text-sm flex items-center justify-center">2</div>
            </div>
        </div>
    );
};
